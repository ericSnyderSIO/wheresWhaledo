function [detTable] = detectClicks_4ch_SOCAL_E_63_reflectRem(tstart, tend, XH, H, c, pingThresh, RRth, paramFile)
...
while t2<=tend
    ...
    for i = 1:length(ind)
        ...
        for pn = 1:length(detParam.xcRow) % iterate through each hydrophone pair
            ...
            if (RRth*xcpks(1))>xcpks(2) % largest peak is significantly bigger than 2nd largest
